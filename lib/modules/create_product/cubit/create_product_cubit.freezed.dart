...
abstract class $CreateProductStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DataStateStatus status, String? err, XFile? pickedImage});
}
...
class _$CreateProductStateImpl
  ...
  const _$CreateProductStateImpl(
      {this.status = DataStateStatus.initial, this.err, this.pickedImage});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CreateProductState(status: $status, err: $err, pickedImage: $pickedImage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, err, pickedImage);
...
abstract class _CreateProductState implements CreateProductState {
  const factory _CreateProductState(
      {final DataStateStatus status,
      final String? err,
      final XFile? pickedImage}) = _$CreateProductStateImpl;
