...
part 'report_transaction_by_payment_method_state.dart';

part 'report_transaction_by_payment_method_cubit.freezed.dart';

class ReportTransactionByPaymentMethodCubit extends BaseCubit<ReportTransactionByPaymentMethodState> {
  ...
  void clearTransaction() {
    emit(state.copyWith(transaction: ReportTransactionByPaymentMethod()));
  }
