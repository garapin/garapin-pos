...
class _$AddUserStateImpl implements _AddUserState {
  const _$AddUserStateImpl({this.status = DataStateStatus.initial, this.err});
  ...
  @override
  String toString() {
    return 'AddUserState(status: $status, err: $err)';
  }
...
abstract class _AddUserState implements AddUserState {
  const factory _AddUserState(
      {final DataStateStatus status, final String? err}) = _$AddUserStateImpl;
